...
//	std::string filenpaths = "F:/Data/wuhan/dataaroundGaoJia/gaojia0818/uncorrected-down-road/pc2";
...
//		}
//
//		std::string newdir = Utility::get_parent(filenpaths) + "/shrink_" + Utility::get_name(filenpaths);
//		Utility::ensure_dir(newdir);
//		std::string outputpath = newdir + "/" + Utility::get_name(lasfiles[i]);
//
//		offset.z += 14.0;
//
//		saveLAS(outputpath, cloudin, offset);
//		//close input file
//		ifs.close();
//		std::cout << "current las name is:	" << cloudin->points.size() << std::endl;
//	}
//
//	system("pause");
//	return 0;
